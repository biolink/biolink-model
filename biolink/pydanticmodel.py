...
RetrievalSource.update_forward_refs()
...
RegulatoryRegion.update_forward_refs()
AccessibleDnaRegion.update_forward_refs()
TranscriptionFactorBindingSite.update_forward_refs()
