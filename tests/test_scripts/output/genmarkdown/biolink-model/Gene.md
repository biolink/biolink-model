 ...
 *  class: [gene to gene product relationship](GeneToGeneProductRelationship.md) references: [gene](Gene.md)
 *  class: [gene](Gene.md) references: [gene](Gene.md)
 *  class: [genotype to gene association](GenotypeToGeneAssociation.md) references: [gene](Gene.md)
 *  class: [sequence variant](SequenceVariant.md) references: [gene](Gene.md)
 *  class: [transcript to gene relationship](TranscriptToGeneRelationship.md) references: [gene](Gene.md)
## Fields
