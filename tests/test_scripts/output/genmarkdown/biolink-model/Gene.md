 ...
 *  class: **gene to gene product relationship** *gene to gene product relationship subject* **gene**
 *  class: **gene** *genetically interacts with* **gene**
 *  class: **genotype to gene association** *genotype to gene association object* **gene**
 *  class: **sequence variant** *has gene* **gene**
 *  class: **transcript to gene relationship** *transcript to gene relationship object* **gene**
## Fields

 * _gene associated with condition_
