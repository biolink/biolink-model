 ...
 *  class: [macromolecular machine to cellular component association](MacromolecularMachineToCellularComponentAssociation.md) references: [cellular component](CellularComponent.md)
## Fields
