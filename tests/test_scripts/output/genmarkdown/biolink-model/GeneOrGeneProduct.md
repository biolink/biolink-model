 ...
 *  class: [chemical to gene association](ChemicalToGeneAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [anatomical entity](AnatomicalEntity.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene as a model of disease association](GeneAsAModelOfDiseaseAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene has variant that contributes to disease association](GeneHasVariantThatContributesToDiseaseAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene regulatory relationship](GeneRegulatoryRelationship.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene regulatory relationship](GeneRegulatoryRelationship.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene to disease association](GeneToDiseaseAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene to expression site association](GeneToExpressionSiteAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene to gene association](GeneToGeneAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene to gene association](GeneToGeneAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene to phenotypic feature association](GeneToPhenotypicFeatureAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene to thing association](GeneToThingAssociation.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene or gene product](GeneOrGeneProduct.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene or gene product](GeneOrGeneProduct.md) references: [gene or gene product](GeneOrGeneProduct.md)
 *  class: [gene or gene product](GeneOrGeneProduct.md) references: [gene or gene product](GeneOrGeneProduct.md)
## Fields
