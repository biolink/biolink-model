 ...
 *  class: [gene to gene product relationship](GeneToGeneProductRelationship.md) references: [gene product](GeneProduct.md)
 *  class: [gene](Gene.md) references: [gene product](GeneProduct.md)
## Fields
