 ...
 *  class: [population to population association](PopulationToPopulationAssociation.md) references: [population of individual organisms](PopulationOfIndividualOrganisms.md)
 *  class: [population to population association](PopulationToPopulationAssociation.md) references: [population of individual organisms](PopulationOfIndividualOrganisms.md)
 *  class: [variant to population association](VariantToPopulationAssociation.md) references: [population of individual organisms](PopulationOfIndividualOrganisms.md)
## Fields
