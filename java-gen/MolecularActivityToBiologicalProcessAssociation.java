...
public class MolecularActivityToBiologicalProcessAssociation {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MolecularActivityToBiologicalProcessAssociation) == false) {
            return false;
        }
        MolecularActivityToBiologicalProcessAssociation rhs = ((MolecularActivityToBiologicalProcessAssociation) other);
