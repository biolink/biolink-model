...
public class MolecularActivityToGeneProductAssociation {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MolecularActivityToGeneProductAssociation) == false) {
            return false;
        }
        MolecularActivityToGeneProductAssociation rhs = ((MolecularActivityToGeneProductAssociation) other);
