...
public class DiseaseToPhenotypicFeatureDenormalizedAssociation {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DiseaseToPhenotypicFeatureDenormalizedAssociation) == false) {
            return false;
        }
        DiseaseToPhenotypicFeatureDenormalizedAssociation rhs = ((DiseaseToPhenotypicFeatureDenormalizedAssociation) other);
