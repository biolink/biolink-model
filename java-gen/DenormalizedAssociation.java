...
public class DenormalizedAssociation {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(providedBy).append(negated).append(objectExtensions).append(hasEvidenceGraph).append(subject).append(associationType).append(qualifiers).append(label).append(subjectExtensions).append(relation).append(hasEvidenceType).append(subjectTaxonClosureLabel).append(hasEvidence).append(subjectTaxonLabel).append(id).append(subjectTaxon).append(subjectTaxonClosure).append(object).append(publications).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DenormalizedAssociation) == false) {
            return false;
        }
        DenormalizedAssociation rhs = ((DenormalizedAssociation) other);
        return new EqualsBuilder().append(providedBy, rhs.providedBy).append(negated, rhs.negated).append(objectExtensions, rhs.objectExtensions).append(hasEvidenceGraph, rhs.hasEvidenceGraph).append(subject, rhs.subject).append(associationType, rhs.associationType).append(qualifiers, rhs.qualifiers).append(label, rhs.label).append(subjectExtensions, rhs.subjectExtensions).append(relation, rhs.relation).append(hasEvidenceType, rhs.hasEvidenceType).append(subjectTaxonClosureLabel, rhs.subjectTaxonClosureLabel).append(hasEvidence, rhs.hasEvidence).append(subjectTaxonLabel, rhs.subjectTaxonLabel).append(id, rhs.id).append(subjectTaxon, rhs.subjectTaxon).append(subjectTaxonClosure, rhs.subjectTaxonClosure).append(object, rhs.object).append(publications, rhs.publications).isEquals();
    }
