...
public class MolecularActivityToDownstreamMolecularActivityAssociation {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MolecularActivityToDownstreamMolecularActivityAssociation) == false) {
            return false;
        }
        MolecularActivityToDownstreamMolecularActivityAssociation rhs = ((MolecularActivityToDownstreamMolecularActivityAssociation) other);
