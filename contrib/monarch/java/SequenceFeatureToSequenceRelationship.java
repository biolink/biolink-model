...
public class SequenceFeatureToSequenceRelationship {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SequenceFeatureToSequenceRelationship) == false) {
            return false;
        }
        SequenceFeatureToSequenceRelationship rhs = ((SequenceFeatureToSequenceRelationship) other);
