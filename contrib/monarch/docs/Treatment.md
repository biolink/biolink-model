...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/\[Treatment|id(i):identifier_type%20%3F;name(i):label_type%20%3F;category(i):iri_type%20*;node_property(i):string%20%3F;iri(i):iri_type%20%3F;full_name(i):label_type%20%3F;description(i):narrative_text%20%3F;systematic_synonym(i):label_type%20%3F;has_phenotype(i):phenotype%20%3F]-%20related%20to(i)%20%3F>\[NamedThing],%20\[Treatment]-%20has%20exposure%20parts%20+>\[DrugExposure],%20\[Treatment]-%20treats>\[DiseaseOrPhenotypicFeature],%20\[SequenceVariantModulatesTreatmentAssociation]-%20object(i)>\[Treatment],%20\[Environment]^-\[Treatment])
## Mappings
