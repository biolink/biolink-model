...
public class NamedThing {
     ...
     */
    @JsonProperty("uri")
    @JsonPropertyDescription("URI expansion of CURIE")
    private String uri;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("category", category).append("description", description).append("fullName", fullName).append("id", id).append("iri", iri).append("name", name).append("nodeProperty", nodeProperty).append("relatedTo", relatedTo).append("systematicSynonym", systematicSynonym).append("uri", uri).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(iri).append(nodeProperty).append(systematicSynonym).append(name).append(description).append(fullName).append(id).append(category).append(uri).append(relatedTo).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(iri, rhs.iri).append(nodeProperty, rhs.nodeProperty).append(systematicSynonym, rhs.systematicSynonym).append(name, rhs.name).append(description, rhs.description).append(fullName, rhs.fullName).append(id, rhs.id).append(category, rhs.category).append(uri, rhs.uri).append(relatedTo, rhs.relatedTo).isEquals();
    }
