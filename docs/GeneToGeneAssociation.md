...
_abstract parent class for different kinds of gene-gene or gene product to gene product relationships. Includes homology and interaction._
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **GeneToGeneAssociation**
            ...
            * [GeneToGeneCoexpressionAssociation](GeneToGeneCoexpressionAssociation.md) [ gene expression mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [GeneOrGeneProduct](GeneOrGeneProduct.md) | 1..1 | the subject gene in the association. If the relation is symmetric, subject vs object is arbitrary. We allow a gene product to stand as a proxy for the gene or vice versa.  | . |
...
| [object](object.md) | [GeneOrGeneProduct](GeneOrGeneProduct.md) | 1..1 | the object gene in the association. If the relation is symmetric, subject vs object is arbitrary. We allow a gene product to stand as a proxy for the gene or vice versa.  | . |
