...
## disease to phenotypic feature denormalized association


None

URI: [http://bioentity.io/vocab/DiseaseToPhenotypicFeatureDenormalizedAssociation](http://bioentity.io/vocab/DiseaseToPhenotypicFeatureDenormalizedAssociation)
## Mappings


## Inheritance

 *  is_a: [disease to phenotypic feature association](DiseaseToPhenotypicFeatureAssociation.html)
