...
URI: [biolink:gene_to_disease_or_phenotypic_feature_association_predicate](https://w3id.org/biolink/gene_to_disease_or_phenotypic_feature_association_predicate)
