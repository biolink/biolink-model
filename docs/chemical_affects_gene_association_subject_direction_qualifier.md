...
URI: [biolink:chemical_affects_gene_association_subject_direction_qualifier](https://w3id.org/biolink/chemical_affects_gene_association_subject_direction_qualifier)
