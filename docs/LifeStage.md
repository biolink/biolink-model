...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[OrganismalEntity],[OrganismTaxon],[GeneToExpressionSiteAssociation]-%20stage%20qualifier%200..1%3E[LifeStage%7Cprovided_by(i):string%20%2A;xref(i):uriorcurie%20%2A;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[GeneExpressionMixin]-%20stage%20qualifier%200..1%3E[LifeStage],[GeneToExpressionSiteAssociation]-%20stage%20qualifier(i)%200..1%3E[LifeStage],[OrganismalEntity]%5E-[LifeStage],[GeneToExpressionSiteAssociation],[GeneExpressionMixin],[Attribute],[Association])
