...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **GenotypeToDiseaseAssociation** [ genotype to entity association mixin entity to disease association mixin]
            * [GenotypeAsAModelOfDiseaseAssociation](GenotypeAsAModelOfDiseaseAssociation.md) [ model to disease association mixin entity to disease association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [Genotype](Genotype.md) | 1..1 | a genotype that is associated in some way with a disease state  | . |
| [predicate](predicate.md) | [predicate_type](predicate_type.md) | 1..1 | E.g. is pathogenic for  | . |
| [object](object.md) | [Disease](Disease.md) | 1..1 | a disease that is associated with that genotype  | . |
