...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SequenceAssociation%7Cid(i):string;predicate(i):predicate_type;relation(i):uriorcurie;negated(i):boolean%20%3F]%5E-[GenomicSequenceLocalization],[Association]%5E-[SequenceAssociation],[Publication],[OntologyClass],[NamedThing],[GenomicSequenceLocalization],[Attribute],[Association],[Agent])
