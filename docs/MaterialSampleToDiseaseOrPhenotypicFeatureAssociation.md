...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **MaterialSampleToDiseaseOrPhenotypicFeatureAssociation** [ material sample to entity association mixin entity to disease or phenotypic feature association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [MaterialSample](MaterialSample.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
