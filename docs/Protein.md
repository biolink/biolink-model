...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[ProteinIsoform],[Protein%7Cdescription(i):narrative_text%20%3F;synonym(i):label_type%20%2A;xref(i):iri_type%20%2A;name(i):symbol_type;has_biological_sequence(i):biological_sequence%20%3F;id(i):string;category(i):category_type%20%2B]%5E-[ProteinIsoform],[GeneProduct]%5E-[Protein],[OrganismTaxon],[GeneProduct])
