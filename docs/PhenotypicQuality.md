...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OrganismAttribute]%5E-[PhenotypicQuality%7Cname(i):label_type%20%3F;provided_by(i):string%20%2A;xref(i):uriorcurie%20%2A;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[OrganismAttribute],[OntologyClass],[NamedThing],[Attribute])
