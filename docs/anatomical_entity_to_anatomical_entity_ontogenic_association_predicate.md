...
URI: [biolink:anatomical_entity_to_anatomical_entity_ontogenic_association_predicate](https://w3id.org/biolink/anatomical_entity_to_anatomical_entity_ontogenic_association_predicate)
