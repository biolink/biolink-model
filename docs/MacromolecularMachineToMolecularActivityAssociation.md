...
* [Entity](Entity.md)
    * [Association](Association.md)
        * [FunctionalAssociation](FunctionalAssociation.md)
            * **MacromolecularMachineToMolecularActivityAssociation** [ macromolecular machine to entity association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [MacromolecularMachineMixin](MacromolecularMachineMixin.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [object](object.md) | [MolecularActivity](MolecularActivity.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
