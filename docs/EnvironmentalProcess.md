...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[PlanetaryEntity],[Occurrent],[EnvironmentalProcess%7Cid(i):string;category(i):category_type%20%2B;iri(i):iri_type%20%3F;name(i):label_type%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[Occurrent],[PlanetaryEntity]%5E-[EnvironmentalProcess],[Attribute])
