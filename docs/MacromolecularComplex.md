...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[OrganismTaxon],[MacromolecularMachine],[MacromolecularMachine]%5E-[MacromolecularComplex%7Cname(i):symbol_type%20%3F;has_biological_sequence(i):biological_sequence%20%3F;id(i):string;category(i):category_type%20%2B;iri(i):iri_type%20%3F;source(i):label_type%20%3F],[Attribute])
...
|  |  |  |
| --- | --- | --- |
| **Exact Mappings:** | | WIKIDATA:Q22325163 |
