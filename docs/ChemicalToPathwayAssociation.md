...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **ChemicalToPathwayAssociation** [ chemical to entity association mixin]
...
| [object](object.md) | [Pathway](Pathway.md) | 1..1 | the pathway that is affected by the chemical  | . |
...
attributes:
  subject:
    ...
    alias: subject
    owner: chemical to pathway association
