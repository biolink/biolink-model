...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToDiseaseAssociation** [ variant to entity association mixin entity to disease association mixin]
            * [VariantAsAModelOfDiseaseAssociation](VariantAsAModelOfDiseaseAssociation.md) [ model to disease association mixin entity to disease association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [SequenceVariant](SequenceVariant.md) | 1..1 | a sequence variant in which the allele state is associated in some way with the disease state  | . |
| [predicate](predicate.md) | [predicate_type](predicate_type.md) | 1..1 | E.g. is pathogenic for  | . |
| [object](object.md) | [Disease](Disease.md) | 1..1 | a disease that is associated with that variant  | . |
