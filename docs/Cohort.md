...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[StudyPopulation],[OrganismTaxon],[NamedThing],[StudyPopulation]%5E-[Cohort%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[Attribute],[Agent])
