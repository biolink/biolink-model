...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **DiseaseToPhenotypicFeatureAssociation** [ entity to phenotypic feature association mixin disease to entity association mixin]
...
| [subject](subject.md) | [Disease](Disease.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [object](object.md) | [PhenotypicFeature](PhenotypicFeature.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
