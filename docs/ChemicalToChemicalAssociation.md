...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[ReactionToParticipantAssociation],[Publication],[OntologyClass],[NamedThing],[InformationResource],[EvidenceType],[ChemicalToEntityAssociationMixin],[ChemicalToChemicalDerivationAssociation],[ChemicalEntity]%3Cobject%201..1-%20[ChemicalToChemicalAssociation%7Cpredicate(i):predicate_type;relation(i):string%20%3F;negated(i):boolean%20%3F;type(i):string%20%3F;category(i):category_type%20%2A;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[ChemicalToChemicalAssociation]uses%20-.-%3E[ChemicalToEntityAssociationMixin],[ChemicalToChemicalAssociation]%5E-[ReactionToParticipantAssociation],[ChemicalToChemicalAssociation]%5E-[ChemicalToChemicalDerivationAssociation],[Association]%5E-[ChemicalToChemicalAssociation],[ChemicalEntity],[Attribute],[Association])
