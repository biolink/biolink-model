...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **ChemicalToChemicalAssociation** [ chemical to entity association mixin]
...
| [object](object.md) | [ChemicalEntity](ChemicalEntity.md) | 1..1 | the chemical element that is the target of the statement  | . |
...
attributes:
  subject:
    ...
    alias: subject
    owner: chemical to chemical association
