...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Treatment]-%20has%20procedure%200..%2A%3E[Procedure%7Cprovided_by(i):string%20%2A;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[Procedure]uses%20-.-%3E[ActivityAndBehavior],[NamedThing]%5E-[Procedure],[Treatment],[NamedThing],[Attribute],[ActivityAndBehavior])
