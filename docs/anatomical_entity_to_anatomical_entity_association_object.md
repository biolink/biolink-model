...
URI: [biolink:anatomical_entity_to_anatomical_entity_association_object](https://w3id.org/biolink/anatomical_entity_to_anatomical_entity_association_object)
