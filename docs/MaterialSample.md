...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * [PhysicalEntity](PhysicalEntity.md) [ physical essence]
            * **MaterialSample** [ subject of investigation]
...
| ---  | --- | --- | --- |
| [MaterialSampleDerivationAssociation](MaterialSampleDerivationAssociation.md) | [subject](subject.md) | range | material sample |
| [MaterialSampleToDiseaseOrPhenotypicFeatureAssociation](MaterialSampleToDiseaseOrPhenotypicFeatureAssociation.md) | [subject](subject.md) | range | material sample |
