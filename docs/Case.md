...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[OrganismTaxon],[IndividualOrganism],[CaseToThingAssociationMixin],[CaseToThingAssociationMixin]-%20subject%201..1%3E[Case%7Cid(i):string;category(i):category_type%20%2B;iri(i):iri_type%20%3F;name(i):label_type%20%3F;source(i):label_type%20%3F],[IndividualOrganism]%5E-[Case],[Attribute])
