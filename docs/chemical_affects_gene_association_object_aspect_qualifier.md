...
URI: [biolink:chemical_affects_gene_association_object_aspect_qualifier](https://w3id.org/biolink/chemical_affects_gene_association_object_aspect_qualifier)
