...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[OrganismTaxon],[NucleicAcidEntity],[NamedThing],[ExonToTranscriptRelationship],[ExonToTranscriptRelationship]-%20subject%201..1%3E[Exon%7Chas_biological_sequence(i):biological_sequence%20%3F;is_metabolite(i):boolean%20%3F;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[NucleicAcidEntity]%5E-[Exon],[Attribute],[Agent])
