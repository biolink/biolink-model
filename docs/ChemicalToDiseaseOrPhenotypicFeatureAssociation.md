...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **ChemicalToDiseaseOrPhenotypicFeatureAssociation** [ chemical to entity association mixin entity to disease or phenotypic feature association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [ChemicalEntityOrGeneOrGeneProduct](ChemicalEntityOrGeneOrGeneProduct.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [object](object.md) | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) | 1..1 | the disease or phenotype that is affected by the chemical  | . |
...
attributes:
  subject:
    ...
    alias: subject
    owner: chemical to disease or phenotypic feature association
