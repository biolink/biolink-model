...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[NamedThing],[MolecularMixture%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]%5E-[Drug],[ChemicalMixture]%5E-[MolecularMixture],[Drug],[ChemicalMixture],[Attribute],[Agent])
