...
URI: [biolink:organism_taxon_to_organism_taxon_specialization_predicate](https://w3id.org/biolink/organism_taxon_to_organism_taxon_specialization_predicate)
