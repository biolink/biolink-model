...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[QuantityValue],[OntologyClass],[NamedThing],[ExposureEvent],[DrugExposure],[QuantityValue]%3Chas%20quantitative%20value(i)%200..%2A-++[ChemicalExposure%7Ctimepoint:time_type%20%3F;name(i):label_type%20%3F;provided_by(i):string%20%2A;xref(i):uriorcurie%20%2A;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[ChemicalExposure]uses%20-.-%3E[ExposureEvent],[ChemicalExposure]%5E-[DrugExposure],[Attribute]%5E-[ChemicalExposure],[Attribute])
