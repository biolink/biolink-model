...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[OntologyClass],[NamedThing],[InformationResource],[GeneticInheritance],[EvidenceType],[GeneticInheritance]%3Cobject%201..1-%20[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation%7Cpredicate:predicate_type;negated(i):boolean%20%3F;timepoint(i):time_type%20%3F;type(i):string%20%3F;category(i):category_type%20%2A;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F],[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation]uses%20-.-%3E[DiseaseOrPhenotypicFeatureToEntityAssociationMixin],[Association]%5E-[DiseaseOrPhenotypicFeatureToGeneticInheritanceAssociation],[DiseaseOrPhenotypicFeatureToEntityAssociationMixin],[Attribute],[Association])
