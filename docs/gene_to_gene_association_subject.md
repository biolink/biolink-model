...
URI: [biolink:gene_to_gene_association_subject](https://w3id.org/biolink/gene_to_gene_association_subject)
 ...
 *  [gene to gene homology association➞subject](gene_to_gene_homology_association_subject.md)
