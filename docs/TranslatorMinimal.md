 ...
 * [retrieval source➞resource id](retrieval_source_resource_id.md) - The InformationResource that served as a source for the knowledge expressed in an Edge, or data used to generate this knowledge.
 * [retrieval source➞resource role](retrieval_source_resource_role.md) - The role of the InformationResource in the retrieval of the knowledge expressed in an Edge, or data used to generate this knowledge.
