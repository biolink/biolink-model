...
URI: [biolink:gene_as_a_model_of_disease_association_subject](https://w3id.org/biolink/gene_as_a_model_of_disease_association_subject)
 ...
 *  is_a: [model to disease association mixin➞subject](model_to_disease_association_mixin_subject.md)
