...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **CellLineToDiseaseOrPhenotypicFeatureAssociation** [ cell line to entity association mixin entity to disease or phenotypic feature association mixin]
            * [CellLineAsAModelOfDiseaseAssociation](CellLineAsAModelOfDiseaseAssociation.md) [ model to disease association mixin entity to disease association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [object](object.md) | [DiseaseOrPhenotypicFeature](DiseaseOrPhenotypicFeature.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
