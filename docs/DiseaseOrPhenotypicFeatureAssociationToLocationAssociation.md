...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Provider]%3Cprovided%20by(i)%200..1-%20[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation%7Crelation(i):uriorcurie;id(i):identifier_type;negated(i):boolean%20%3F],%20[Publication]%3Cpublications(i)%200..*-%20[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation],%20[OntologyClass]%3Cqualifiers(i)%200..*-%20[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation],%20[OntologyClass]%3Cassociation%20type(i)%200..1-%20[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation],%20[DiseaseOrPhenotypicFeature]%3Csubject(i)%201..1-%20[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation],%20[AnatomicalEntity]%3Cobject%201..1-%20[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation],%20[DiseaseOrPhenotypicFeatureAssociationToThingAssociation]%5E-[DiseaseOrPhenotypicFeatureAssociationToLocationAssociation])
