...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **DrugToGeneAssociation** [ drug to entity association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [Drug](Drug.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [object](object.md) | [GeneOrGeneProduct](GeneOrGeneProduct.md) | 1..1 | the gene or gene product that is affected by the drug  | . |
