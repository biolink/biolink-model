...
_A relationship between two anatomical entities where the relationship is mereological, i.e the two entities are related by parthood. This includes relationships between cellular components and cells, between cells and tissues, tissues and whole organisms_
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [AnatomicalEntity](AnatomicalEntity.md) | 1..1 | the part  | . |
...
| [object](object.md) | [AnatomicalEntity](AnatomicalEntity.md) | 1..1 | the whole  | . |
...
attributes:
  subject:
    ...
    alias: subject
    owner: anatomical entity to anatomical entity part of association
    range: anatomical entity
    required: true
  predicate:
    name: predicate
