...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Provider]%3Cprovided%20by(i)%200..1-%20[SequenceVariantModulatesTreatmentAssociation%7Crelation(i):uriorcurie;id(i):identifier_type;negated(i):boolean%20%3F],%20[Publication]%3Cpublications(i)%200..*-%20[SequenceVariantModulatesTreatmentAssociation],%20[OntologyClass]%3Cqualifiers(i)%200..*-%20[SequenceVariantModulatesTreatmentAssociation],%20[OntologyClass]%3Cassociation%20type(i)%200..1-%20[SequenceVariantModulatesTreatmentAssociation],%20[Treatment]%3Cobject%201..1-%20[SequenceVariantModulatesTreatmentAssociation],%20[SequenceVariant]%3Csubject%201..1-%20[SequenceVariantModulatesTreatmentAssociation],%20[Association]%5E-[SequenceVariantModulatesTreatmentAssociation])
