...
_An association between a gene and an expression site, possibly qualified by stage/timing info._
...
| ---  | --- | --- | --- | --- |
| [stage_qualifier](stage_qualifier.md) | [LifeStage](LifeStage.md) | 0..1 | stage at which the gene is expressed in the site  | . |
| [quantifier_qualifier](quantifier_qualifier.md) | [OntologyClass](OntologyClass.md) | 0..1 | can be used to indicate magnitude, or also ranking  | . |
| [subject](subject.md) | [GeneOrGeneProduct](GeneOrGeneProduct.md) | 1..1 | gene in which variation is correlated with the phenotypic feature  | . |
| [predicate](predicate.md) | [predicate_type](predicate_type.md) | 1..1 | expression relationship  | . |
| [object](object.md) | [AnatomicalEntity](AnatomicalEntity.md) | 1..1 | location in which the gene is expressed  | . |
