...
* [Entity](Entity.md)
    * [Association](Association.md)
        * [GenotypeToDiseaseAssociation](GenotypeToDiseaseAssociation.md) [ genotype to entity association mixin entity to disease association mixin]
            * **GenotypeAsAModelOfDiseaseAssociation** [ model to disease association mixin entity to disease association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [Genotype](Genotype.md) | 1..1 | A genotype that has a role in modeling the disease.  | . |
