...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **ExposureEventToPhenotypicFeatureAssociation** [ entity to phenotypic feature association mixin]
...
| [subject](subject.md) | [ExposureEvent](ExposureEvent.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
