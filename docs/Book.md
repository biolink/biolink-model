...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[NamedThing],[Publication]%5E-[Book%7Cid:string;type:string;authors(i):string%20%2A;pages(i):string%20%2A;summary(i):string%20%3F;keywords(i):string%20%2A;mesh_terms(i):uriorcurie%20%2A;xref(i):uriorcurie%20%2A;name(i):label_type%20%3F;license(i):string%20%3F;rights(i):string%20%3F;format(i):string%20%3F;creation_date(i):date%20%3F;provided_by(i):string%20%2A;iri(i):iri_type%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[Attribute])
