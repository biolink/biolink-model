...
URI: [biolink:disease_or_phenotypic_feature_to_location_association_object](https://w3id.org/biolink/disease_or_phenotypic_feature_to_location_association_object)
