...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[InformationContentEntity]%5E-[ConfidenceLevel%7Cid(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B])
