...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[PhysicalEssence],[BiologicalProcessOrActivity]-%20enabled%20by%200..%2A%3E[PhysicalEntity%7Cprovided_by(i):string%20%2A;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[PhysicalEntity]uses%20-.-%3E[PhysicalEssence],[PhysicalEntity]%5E-[MaterialSample],[NamedThing]%5E-[PhysicalEntity],[NamedThing],[MaterialSample],[BiologicalProcessOrActivity],[Attribute])
