...
* [Entity](Entity.md)
    * [NamedThing](NamedThing.md)
        * **Treatment** [ exposure event chemical or drug or treatment]
...
| ---  | --- | --- | --- | --- |
| [has_drug](has_drug.md) | [Drug](Drug.md) | 0..* | connects an entity to one or more drugs  | . |
| [has_device](has_device.md) | [Device](Device.md) | 0..* | connects an entity to one or more (medical) devices  | . |
| [has_procedure](has_procedure.md) | [Procedure](Procedure.md) | 0..* | connects an entity to one or more (medical) procedures  | . |
...
| ---  | --- | --- | --- |
| [SequenceVariantModulatesTreatmentAssociation](SequenceVariantModulatesTreatmentAssociation.md) | [object](object.md) | range | treatment |
