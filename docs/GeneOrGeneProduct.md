 ...
 *  **[CellularComponent](CellularComponent.md)** *[has active component](has_active_component.md)*  <sub>0..1</sub>  **[GeneOrGeneProduct](GeneOrGeneProduct.md)**
