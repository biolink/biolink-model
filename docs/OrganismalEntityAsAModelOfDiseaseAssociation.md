...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **OrganismalEntityAsAModelOfDiseaseAssociation** [ model to disease association mixin entity to disease association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [OrganismalEntity](OrganismalEntity.md) | 1..1 | A organismal entity (strain, breed) with a predisposition to a disease, or bred/created specifically to model a disease.  | . |
