...
| ---  | --- | --- | --- | --- |
| [interacting_molecules_category](interacting_molecules_category.md) | [OntologyClass](OntologyClass.md) | 0..1 | None  | . |
...
| [predicate](predicate.md) | [predicate_type](predicate_type.md) | 1..1 | interaction relationship type  | . |
| [object](object.md) | [MolecularEntity](MolecularEntity.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [id](id.md) | [string](string.md) | 1..1 | identifier for the interaction. This may come from an interaction database such as IMEX.  | . |
