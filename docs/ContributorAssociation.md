...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [InformationContentEntity](InformationContentEntity.md) | 1..1 | information content entity which an agent has helped realise  | . |
| [predicate](predicate.md) | [predicate_type](predicate_type.md) | 1..1 | generally one of the predicate values 'provider', 'publisher', 'editor' or 'author'  | . |
| [object](object.md) | [Agent](Agent.md) | 1..1 | agent helping to realise the given entity (e.g. such as a publication)  | . |
...
| [qualifiers](qualifiers.md) | [OntologyClass](OntologyClass.md) | 0..* | this field can be used to annotate special characteristics of an agent relationship, such as the fact that a given author agent of a publication is the 'corresponding author'  | . |
