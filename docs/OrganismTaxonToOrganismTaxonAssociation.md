...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [OrganismTaxon](OrganismTaxon.md) | 1..1 | connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
...
| [object](object.md) | [OrganismTaxon](OrganismTaxon.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
