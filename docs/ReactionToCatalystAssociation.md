 ...
 * [reaction to catalyst association➞object](reaction_to_catalyst_association_object.md)  <sub>1..1</sub>
 ...
 * [reaction to participant association➞subject](reaction_to_participant_association_subject.md)  <sub>1..1</sub>
     * Description: connects an association to the subject of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.
