...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[OrganismTaxon]%3Cobject%201..1-%20[TaxonToTaxonAssociation%7Cpredicate(i):predicate_type;negated(i):boolean%20%3F;type(i):string%20%3F;category(i):category_type%20%2A;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F],[OrganismTaxon]%3Csubject%201..1-%20[TaxonToTaxonAssociation],[Association]%5E-[TaxonToTaxonAssociation],[Publication],[OrganismTaxon],[OntologyClass],[InformationResource],[EvidenceType],[Attribute],[Association])
