...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **DiseaseToExposureEventAssociation** [ disease to entity association mixin entity to exposure event association mixin]
...
| [object](object.md) | [ExposureEvent](ExposureEvent.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
