...
URI: [biolink:chemical_entity_assesses_named_thing_association_predicate](https://w3id.org/biolink/chemical_entity_assesses_named_thing_association_predicate)
