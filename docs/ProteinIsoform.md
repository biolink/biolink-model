...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[ProteinIsoform%7Csynonym(i):label_type%20%2A;xref(i):uriorcurie%20%2A;provided_by(i):string%20%2A;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):string%20%3F]uses%20-.-%3E[GeneProductIsoformMixin],[Protein]%5E-[ProteinIsoform],[Protein],[OrganismTaxon],[NamedThing],[GeneProductIsoformMixin],[Attribute])
