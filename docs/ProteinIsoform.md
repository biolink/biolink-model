...
![img](http://yuml.me/diagram/nofunky/class/[protein|]^-[protein isoform|has biological sequence;id;name;category;in taxon], [protein isoform|has biological sequence;id;name;category;in taxon]-in taxon >[organism taxon|], [ontology class|]^-[organism taxon|])
## Mappings
