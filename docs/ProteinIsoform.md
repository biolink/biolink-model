...
![img](https://yuml.me/diagram/nofunky;dir:TB/class/[ProteinIsoform%7Cin_taxon_label(i):label_type%20%3F;provided_by(i):string%20%2A;xref(i):uriorcurie%20%2A;full_name(i):label_type%20%3F;synonym(i):label_type%20%2A;category(i):category_type%20%2B;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%2A;name(i):label_type%20%3F;description(i):narrative_text%20%3F]uses%20-.-%3E[GeneProductIsoformMixin],[Protein]%5E-[ProteinIsoform],[Protein],[OrganismTaxon],[GeneProductIsoformMixin],[Attribute])
