...
URI: [biolink:molecular_activity_to_molecular_activity_association_subject](https://w3id.org/biolink/molecular_activity_to_molecular_activity_association_subject)
