...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[NamedThing],[Attribute],[Agent],[AdministrativeEntity%7Cid(i):string;category(i):category_type%20%2B;iri(i):iri_type%20%3F;name(i):label_type%20%3F;source(i):label_type%20%3F]%5E-[Agent],[NamedThing]%5E-[AdministrativeEntity])
