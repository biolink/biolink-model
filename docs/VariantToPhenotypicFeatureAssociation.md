...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToPhenotypicFeatureAssociation** [ variant to entity association mixin entity to phenotypic feature association mixin]
...
| [subject](subject.md) | [SequenceVariant](SequenceVariant.md) | 1..1 | a sequence variant in which the allele state is associated in some way with the phenotype state  | . |
