...
* [Entity](Entity.md)
    * [Association](Association.md)
        * [FunctionalAssociation](FunctionalAssociation.md)
            * **MacromolecularMachineToBiologicalProcessAssociation** [ macromolecular machine to entity association mixin]
...
| [object](object.md) | [BiologicalProcess](BiologicalProcess.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
