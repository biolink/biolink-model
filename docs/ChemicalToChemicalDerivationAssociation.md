...
_A causal relationship between two chemical entities, where the subject represents the upstream entity and the object represents the downstream. For any such association there is an implicit reaction:
  IF
  R has-input C1 AND
  R has-output C2 AND
  R enabled-by P AND
  R type Reaction
  THEN
  C1 derives-into C2 <<catalyst qualifier P>>_
...
| ---  | --- | --- | --- | --- |
| [catalyst_qualifier](catalyst_qualifier.md) | [MacromolecularMachineMixin](MacromolecularMachineMixin.md) | 0..* | this connects the derivation edge to the chemical entity that catalyzes the reaction that causes the subject chemical to transform into the object chemical.  | . |
| [subject](subject.md) | [ChemicalEntity](ChemicalEntity.md) | 1..1 | the upstream chemical entity  | . |
...
| [object](object.md) | [ChemicalEntity](ChemicalEntity.md) | 1..1 | the downstream chemical entity  | . |
...
attributes:
  catalyst qualifier:
    ...
    owner: chemical to chemical derivation association
