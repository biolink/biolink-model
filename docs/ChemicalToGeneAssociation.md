...
_An interaction between a chemical entity and a gene or gene product._
...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **ChemicalToGeneAssociation** [ chemical to entity association mixin]
...
| [object](object.md) | [GeneOrGeneProduct](GeneOrGeneProduct.md) | 1..1 | the gene or gene product that is affected by the chemical.  | . |
...
attributes:
  subject:
    ...
    alias: subject
    owner: chemical to gene association
