...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Outcome],[NamedThing],[EpidemiologicalOutcome%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[Outcome],[BiologicalEntity]%5E-[EpidemiologicalOutcome],[BiologicalEntity],[Attribute],[Agent])
