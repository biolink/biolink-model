...
URI: [biolink:chemical_affects_gene_association_subject_form_or_variant_qualifier](https://w3id.org/biolink/chemical_affects_gene_association_subject_form_or_variant_qualifier)
