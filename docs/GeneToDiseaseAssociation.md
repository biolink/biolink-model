...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **GeneToDiseaseAssociation** [ entity to disease association mixin gene to entity association mixin]
            * [GeneAsAModelOfDiseaseAssociation](GeneAsAModelOfDiseaseAssociation.md) [ model to disease association mixin entity to disease association mixin]
...
| ---  | --- | --- | --- | --- |
| [subject](subject.md) | [GeneOrGeneProduct](GeneOrGeneProduct.md) | 1..1 | gene in which variation is correlated with the disease, may be protective or causative or associative, or as a model  | . |
