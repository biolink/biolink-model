...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **ExposureEventToOutcomeAssociation** [ exposure event to entity association mixin entity to outcome association mixin]
...
| ---  | --- | --- | --- | --- |
| [has_population_context](has_population_context.md) | [PopulationOfIndividualOrganisms](PopulationOfIndividualOrganisms.md) | 0..1 | a biological population (general, study, cohort, etc.) with a specific set of characteristics to constrain an association.  | . |
| [has_temporal_context](has_temporal_context.md) | [time_type](time_type.md) | 0..1 | a constraint of time placed upon the truth value of an association.  | . |
...
| [object](object.md) | [Outcome](Outcome.md) | 1..1 | connects an association to the object of the association. For example, in a gene-to-phenotype association, the gene is subject and phenotype is object.  | . |
