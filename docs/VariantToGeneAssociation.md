...
* [Entity](Entity.md)
    * [Association](Association.md)
        * **VariantToGeneAssociation** [ variant to entity association mixin]
            * [VariantToGeneExpressionAssociation](VariantToGeneExpressionAssociation.md) [ gene expression mixin]
