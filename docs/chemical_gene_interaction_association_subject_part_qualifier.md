...
URI: [biolink:chemical_gene_interaction_association_subject_part_qualifier](https://w3id.org/biolink/chemical_gene_interaction_association_subject_part_qualifier)
