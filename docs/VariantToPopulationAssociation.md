...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Provider]%3Cprovided%20by(i)%200..1-%20[VariantToPopulationAssociation%7Chas_count:integer%20%3F;has_total:integer%20%3F;has_quotient:double%20%3F;relation(i):uriorcurie;id(i):identifier_type;negated(i):boolean%20%3F],%20[Publication]%3Cpublications(i)%200..*-%20[VariantToPopulationAssociation],%20[OntologyClass]%3Cqualifiers(i)%200..*-%20[VariantToPopulationAssociation],%20[OntologyClass]%3Cassociation%20type(i)%200..1-%20[VariantToPopulationAssociation],%20[PopulationOfIndividualOrganisms]%3Cobject%201..1-%20[VariantToPopulationAssociation],%20[SequenceVariant]%3Csubject%201..1-%20[VariantToPopulationAssociation],%20[VariantToPopulationAssociation]uses%20-.-%3E[VariantToThingAssociation],%20[VariantToPopulationAssociation]uses%20-.-%3E[FrequencyQuantifier],%20[VariantToPopulationAssociation]uses%20-.-%3E[FrequencyQualifierMixin],%20[Association]%5E-[VariantToPopulationAssociation])
