...
public class BiologicalProcessOrActivity {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("enabledBy", enabledBy).append("hasInput", hasInput).append("hasOutput", hasOutput).append("hasParticipant", hasParticipant).append("precedes", precedes).append("regulatesProcessToProcess", regulatesProcessToProcess).toString();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(enabledBy).append(precedes).append(hasOutput).append(regulatesProcessToProcess).append(hasInput).append(hasParticipant).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(enabledBy, rhs.enabledBy).append(precedes, rhs.precedes).append(hasOutput, rhs.hasOutput).append(regulatesProcessToProcess, rhs.regulatesProcessToProcess).append(hasInput, rhs.hasInput).append(hasParticipant, rhs.hasParticipant).isEquals();
    }
